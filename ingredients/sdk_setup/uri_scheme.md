...
Go do a quick double-check that this is the same URI scheme listed on the Dashboard, where it should be `myapp://`). {% section dashboard_uri %}For more info on setting up a URI scheme on the Dashboard, [click here](/recipes/configuring_the_dashboard/{{page.platform}}/#uri-scheme).{% endsection %}
