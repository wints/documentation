...
Lastly, if you want to use a root-level domain, you can purchase one and make use of a service like CloudFlare. We recommend using a domain other than your main website's domain i.e. a.co if your website's domain is apple.com. Check out the following two articles:
