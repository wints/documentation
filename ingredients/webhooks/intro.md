...
For more information about event tracking--including events that Branch automatically tracks and custom events specified by the developer--see [analytics and custom events](/recipes/analytics_and_custom_events/{{page.platform}}/).
