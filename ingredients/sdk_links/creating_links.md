...
{% section sdk_links_creating_links_explanation %}
...
~~~objc
[[Branch getInstance] getShortURLWithParams:{% section sdk_links_creating_links_params %}@{@"foo": @"bar"}{%endsection%} andCallback:^(NSString *url, NSError *error) {
